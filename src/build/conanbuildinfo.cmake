...
set(CONAN_LIBELF_ROOT "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df")
set(CONAN_INCLUDE_DIRS_LIBELF "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/include")
set(CONAN_LIB_DIRS_LIBELF "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/lib")
set(CONAN_BIN_DIRS_LIBELF )
set(CONAN_RES_DIRS_LIBELF )
set(CONAN_SRC_DIRS_LIBELF )
set(CONAN_BUILD_DIRS_LIBELF "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/")
...
set(CONAN_INCLUDE_DIRS "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS elf ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/home/kaiyin/.conan/data/libelf/0.8.13/bincrafters/stable/package/ec336a8e46e06995be9ad34dc1a7477dff42a7df/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_LIBELF}" "${CONAN_LIB_DIRS_LIBELF}"
                                  CONAN_PACKAGE_TARGETS_LIBELF "" "" libelf)
    conan_package_library_targets("${CONAN_LIBS_LIBELF_DEBUG}" "${CONAN_LIB_DIRS_LIBELF_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_LIBELF_DEBUG "" "debug" libelf)
    conan_package_library_targets("${CONAN_LIBS_LIBELF_RELEASE}" "${CONAN_LIB_DIRS_LIBELF_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_LIBELF_RELEASE "" "release" libelf)

    add_library(CONAN_PKG::libelf INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::libelf PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_LIBELF} ${CONAN_SHARED_LINKER_FLAGS_LIBELF_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBELF_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_LIBELF_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBELF_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBELF_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_LIBELF_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBELF_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBELF_RELEASE_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_LIBELF_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_LIBELF_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBELF_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_LIBELF_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_LIBELF_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_LIBELF_DEBUG_LIST}>
                                                                 )
    set_property(TARGET CONAN_PKG::libelf PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_LIBELF}
                                                                      ...
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_LIBELF_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_LIBELF_RELEASE}>
    ...
    set_property(TARGET CONAN_PKG::libelf PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_LIBELF}
                                                                      ...
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_LIBELF_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_LIBELF_RELEASE}>
    ...
    set_property(TARGET CONAN_PKG::libelf PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_LIBELF_LIST} ${CONAN_CXX_FLAGS_LIBELF_LIST}
                                                                  ...
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_LIBELF_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBELF_RELEASE_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_LIBELF_RELEASE_LIST} ${CONAN_CXX_FLAGS_LIBELF_RELEASE_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_LIBELF_DEBUG_LIST}  ${CONAN_CXX_FLAGS_LIBELF_DEBUG_LIST}>)
 
    set(CONAN_TARGETS CONAN_PKG::libelf)
